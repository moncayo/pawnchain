...
const Navbar = () => {
    ...
    return (
        <div className="nav-wrapper">
            ...
            { currentAccount ? <h1 className="address-container">{currentAccount}</h1> : <div className="connect-button-wrapper"> <button disabled={!ethereum} className="connect-button" onClick={connectWallet}>Connect<img className="metamask-icon" src={Metamask_icon} alt="metamask-logo.png"/></button></div> }
        </div>
    );
}
